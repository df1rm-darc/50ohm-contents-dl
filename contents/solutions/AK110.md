...
3. Die Leistung beträgt: $P_{ERP} = \qty{75}{\watt}$
...
$P_{EIRP} = \qty{75}{\watt} \cdot 10^{\frac{11,5 - 1,5 + 2,15}{10}} = \qty{1230,44}{\watt}$

2. Berechnung von $d$:

$d = \frac{\sqrt{\qty{30}{\Ohm} \cdot \qty{1230,44}{\watt}}}{\qty{28}{\frac{\volt}{\meter}}} = \frac{\qty{192,12}{\volt}}{\qty{28}{\frac{\volt}{\meter}}} = \qty{6,86}{\meter}$


## Interpretation

Die gesuchte Sicherheitsabstand beträgt $\qty{6,86}{\meter}$.
